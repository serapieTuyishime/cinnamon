...
export default function Testimonials() {
    return (
        <div className="flex px-20 py-32">
            <div className="grid gap-10">
                <h1 className="text-4.3xl font-montBold leading-snug w-4/5 ">
                    They’re consistent, and the communication is good.
                </h1>
                <p className="text-grey w-4/5">
            ...
            <div className="w-1/4 flex flex-col pt-8 justify-between">
                <Image src="/ping.png" width={200} height={67.94} alt="ping" />
