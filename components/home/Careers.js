...
export default function Careers() {
    return (
        <div className="dark-area">
            <div className="px-6 lg:px-0 container mx-auto max-w-6xl py-28 lg:py-40 justify-between grid lg:flex gap-24">
                <div className="grid gap-8 lg:w-1/2 ">
                    <h1 className="text-4xl lg:text-5.5xl font-montBold">
                        We’re growing
                    </h1>
